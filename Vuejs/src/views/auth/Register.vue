    ...
    <div>
        ...
        <div class="login">
            <div class="top d-flex align-items-center justify-content-center">
                ...
                <div class="col2">
                    <form @submit.prevent="actionRegister" class="form">
                        ...
                        <div class="form-group mb-3">
                            <input class="form-control" type="password" placeholder="Password Confirmaintion"
                                v-model="credentials.password_confirmation">
                        </div>
                        <div>
                            <button type="submit" class="btn btn-primary btn-login mb-3">Register</button>
                        </div>
                        <div class="forgot">
                            <a href="">Forgotten password?</a>
                        </div>
                        <div>
                            <button @click="redirectLogin" type="button" class="btn btn-success btn-create mt-3">Login</button>
                        </div>
                    </form>
...
const actionRegister = (() => {
    axios.post('/register', credentials.value)
        .then(() => router.push({name: 'login', params: {}}))
        .catch((e) => {
...
const redirectLogin = (() => router.push({name: 'login', params: {}}))
